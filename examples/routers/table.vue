      ...
      <Layout :style="{minHeight: '80vh'}">
        ...
        <Layout class-name="test-class">
          ...
          <Content :style="{background:'#FFCF9E'}">
            ...
            <Table border :columns="columns4" @on-select="handleSelect" @on-select-all="handleAll" @on-cancel-all="handleCancelAll" @on-selection-change="handleSelectionChange"
              height="240" :data="data4"></Table>
          </Content>
